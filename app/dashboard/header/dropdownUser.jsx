...
export default  function DropdownUser () {
  ...
  // close on click outside. target is Mouse event
  useEffect(() => {
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`absolute right-0 mt-4 flex 
        w-62.5 flex-col rounded-sm border border-stroke 
      ...
      >
        ...
        <button className="flex items-center gap-3.5 py-4 px-6 
